...
public interface DistributedLocker {
     ...
     * @param runnable    加锁成功才会执行
     */
    default void lock(String business, List<Object> resources, long waitTime, long releaseTime, Runnable runnable) {
        lock(null, business, resources, waitTime, releaseTime, runnable);
    }
     ...
     * @param runnable    加锁成功才会执行
     */
    default void lock(String prefix, String business, List<Object> resources, long waitTime, long releaseTime,
                      Runnable runnable) {
     ...
     * @throws Exception callable exception
     */
    default <T> T lock(String business, List<Object> resources, long waitTime, long releaseTime,
                       Callable<T> callable) throws Exception {
        return lock(null, business, resources, waitTime, releaseTime, callable);
    }
     ...
     * @throws Exception callable exception
     */
    default <T> T lock(String prefix, String business, List<Object> resources, long waitTime, long releaseTime,
                       Callable<T> callable) throws Exception {
