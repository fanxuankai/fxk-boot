...
CREATE TABLE `sys_log` (
  ...
  `application` varchar(255) DEFAULT NULL COMMENT '应用名',
  `resource` varchar(255) DEFAULT NULL COMMENT '资源名称',
  `resource_id` varchar(255) DEFAULT NULL COMMENT '资源 id',
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'url 地址',
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统日志';
```
- 配置
```yml
spring:
